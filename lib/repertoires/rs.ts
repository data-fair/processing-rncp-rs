...
// Résumé repris tel quel de la prod (koumoul.com/.../competences-rs), utilisé à la création.
const DATASET_SUMMARY = 'Le Répertoire spécifique (RS) France compétences liste les certifications professionnelles reconnues (hors RNCP) : intitulés, organismes certificateurs, niveaux, compétences visées et secteurs d’activité. Ressource clé pour la formation, la VAE et l’insertion professionnelle.'
